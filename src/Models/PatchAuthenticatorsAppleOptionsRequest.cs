...
/// </summary>
[JsonConverter(typeof(PatchConverter<PatchAuthenticatorsAppleOptionsRequest>))]
public class PatchAuthenticatorsAppleOptionsRequest
{
   /// <summary>
   ...
   /// </summary>
   public Optional<string> KeyId { get; set; }
}
