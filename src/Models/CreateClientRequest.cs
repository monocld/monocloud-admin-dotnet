...
public class CreateClientRequest
{
   ...
   /// </summary>
   public List<CreateSecretRequest> Secrets { get; set; } = new();
   ...
   /// </summary>
   public RememberConsentTypes RememberConsent { get; set; } = default;

   /// <summary>
   /// Specifies whether or not the user is allowed to select the scopes on the consent screen
   /// </summary>
   public bool ShowConsentScopeSelection { get; set; } = true;
   ...
   /// </summary>
   public List<GrantTypes> AllowedGrantTypes { get; set; } = new();
   ...
   /// </summary>
   public bool BindTokensToSession { get; set; } = false;
   ...
   /// </summary>
   public RefreshTokenUsageTypes RefreshTokenUsage { get; set; } = default;
   ...
   /// </summary>
   public RefreshTokenExpirationTypes RefreshTokenExpiration { get; set; } = default;

   /// <summary>
   /// Specifies whether the access token is a reference token or a self contained JWT token.
   /// </summary>
   public AccessTokenTypes AccessTokenType { get; set; } = default;

   /// <summary>
   /// Specifies which authenticators can be used with this client (if list is empty all authenticators are allowed)
   /// </summary>
   public List<Authenticators> AuthenticatorRestrictions { get; set; } = new();
   ...
   /// </summary>
   public DeviceFlowCodeTypes UserCodeType { get; set; } = default;

   /// <summary>
   /// Specifies the length of code that will be generated for the device code flow
   /// </summary>
   public int DeviceCodeLength { get; set; } = 6;
